...
--
-- Class PurchaseOrder as table purchase_order
--
...
--
-- Class PurchaseOrderItem as table purchase_order_item
--
...
--
-- Class VendorProfile as table vendor_profile
--
...
--
-- Foreign relations for "purchase_order" table
--
...
--
-- Foreign relations for "purchase_order_item" table
--
...
--
-- Foreign relations for "vendor_profile" table
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('placeify', '20260605132946843', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260605132946843', "timestamp" = now();
