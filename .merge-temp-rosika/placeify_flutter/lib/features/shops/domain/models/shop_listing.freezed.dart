...
mixin _$ShopListing {
 ...
 String get vendorId; String get businessName; String get locality; List<String> get tags; String? get logoUrl; String? get bannerUrl; int get productCount; double get averageRating;
...
@useResult
$Res call({
 String vendorId, String businessName, String locality, List<String> tags, String? logoUrl, String? bannerUrl, int productCount, double averageRating
});
...
/// Create a copy of ShopListing
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? vendorId = null,Object? businessName = null,Object? locality = null,Object? tags = null,Object? logoUrl = freezed,Object? bannerUrl = freezed,Object? productCount = null,Object? averageRating = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String vendorId,  String businessName,  String locality,  List<String> tags,  String? logoUrl,  String? bannerUrl,  int productCount,  double averageRating)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ShopListing() when $default != null:
return $default(_that.vendorId,_that.businessName,_that.locality,_that.tags,_that.logoUrl,_that.bannerUrl,_that.productCount,_that.averageRating);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String vendorId,  String businessName,  String locality,  List<String> tags,  String? logoUrl,  String? bannerUrl,  int productCount,  double averageRating)  $default,) {final _that = this;
switch (_that) {
case _ShopListing():
return $default(_that.vendorId,_that.businessName,_that.locality,_that.tags,_that.logoUrl,_that.bannerUrl,_that.productCount,_that.averageRating);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String vendorId,  String businessName,  String locality,  List<String> tags,  String? logoUrl,  String? bannerUrl,  int productCount,  double averageRating)?  $default,) {final _that = this;
switch (_that) {
case _ShopListing() when $default != null:
return $default(_that.vendorId,_that.businessName,_that.locality,_that.tags,_that.logoUrl,_that.bannerUrl,_that.productCount,_that.averageRating);case _:
  return null;
...
class _ShopListing implements ShopListing {
  const _ShopListing({required this.vendorId, required this.businessName, required this.locality, final  List<String> tags = const [], this.logoUrl, this.bannerUrl, this.productCount = 0, this.averageRating = 0}): _tags = tags;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ShopListing&&(identical(other.vendorId, vendorId) || other.vendorId == vendorId)&&(identical(other.businessName, businessName) || other.businessName == businessName)&&(identical(other.locality, locality) || other.locality == locality)&&const DeepCollectionEquality().equals(other._tags, _tags)&&(identical(other.logoUrl, logoUrl) || other.logoUrl == logoUrl)&&(identical(other.bannerUrl, bannerUrl) || other.bannerUrl == bannerUrl)&&(identical(other.productCount, productCount) || other.productCount == productCount)&&(identical(other.averageRating, averageRating) || other.averageRating == averageRating));
}


@override
int get hashCode => Object.hash(runtimeType,vendorId,businessName,locality,const DeepCollectionEquality().hash(_tags),logoUrl,bannerUrl,productCount,averageRating);
...
/// Create a copy of ShopListing
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? vendorId = null,Object? businessName = null,Object? locality = null,Object? tags = null,Object? logoUrl = freezed,Object? bannerUrl = freezed,Object? productCount = null,Object? averageRating = null,}) {
