...
mixin _$OrderStatusUpdate {
  ConsumerOrderStatus get status;
  ...
  $OrderStatusUpdateCopyWith<OrderStatusUpdate> get copyWith =>
      _$OrderStatusUpdateCopyWithImpl<OrderStatusUpdate>(
          this as OrderStatusUpdate, _$identity);
...
abstract mixin class $OrderStatusUpdateCopyWith<$Res> {
  factory $OrderStatusUpdateCopyWith(
          OrderStatusUpdate value, $Res Function(OrderStatusUpdate) _then) =
      _$OrderStatusUpdateCopyWithImpl;
  @useResult
  $Res call({ConsumerOrderStatus status, DateTime timestamp, String? note});
}
...
class _OrderStatusUpdate implements OrderStatusUpdate {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$OrderStatusUpdateCopyWith<_OrderStatusUpdate> get copyWith =>
      __$OrderStatusUpdateCopyWithImpl<_OrderStatusUpdate>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$OrderStatusUpdateToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$OrderStatusUpdateCopyWith<$Res>
    implements $OrderStatusUpdateCopyWith<$Res> {
  factory _$OrderStatusUpdateCopyWith(
          _OrderStatusUpdate value, $Res Function(_OrderStatusUpdate) _then) =
      __$OrderStatusUpdateCopyWithImpl;
  @override
  @useResult
  $Res call({ConsumerOrderStatus status, DateTime timestamp, String? note});
}
