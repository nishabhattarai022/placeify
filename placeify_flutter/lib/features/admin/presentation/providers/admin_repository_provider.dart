...
import 'package:placeify_flutter/features/admin/data/hybrid_admin_repository.dart';
...
Future<AdminRepository> adminRepository(Ref ref) async {
  ...
  final fallback = MockAdminRepository(authRepo, prefs, applicationRepo);
  return HybridAdminRepository(fallback, const ServerpodAdminApi());
}
