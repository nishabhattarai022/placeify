...
mixin _$VendorApplication {
 ...
 String get vendorId; String get userId; String get businessName; String get contactEmail; DateTime get submittedAt; VendorRegistration get registration; VendorStatus get status; String? get moderationNote; DateTime? get moderatedAt; String? get appealMessage; DateTime? get appealSubmittedAt;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is VendorApplication&&(identical(other.vendorId, vendorId) || other.vendorId == vendorId)&&(identical(other.userId, userId) || other.userId == userId)&&(identical(other.businessName, businessName) || other.businessName == businessName)&&(identical(other.contactEmail, contactEmail) || other.contactEmail == contactEmail)&&(identical(other.submittedAt, submittedAt) || other.submittedAt == submittedAt)&&(identical(other.registration, registration) || other.registration == registration)&&(identical(other.status, status) || other.status == status)&&(identical(other.moderationNote, moderationNote) || other.moderationNote == moderationNote)&&(identical(other.moderatedAt, moderatedAt) || other.moderatedAt == moderatedAt)&&(identical(other.appealMessage, appealMessage) || other.appealMessage == appealMessage)&&(identical(other.appealSubmittedAt, appealSubmittedAt) || other.appealSubmittedAt == appealSubmittedAt));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,vendorId,userId,businessName,contactEmail,submittedAt,registration,status,moderationNote,moderatedAt,appealMessage,appealSubmittedAt);

@override
String toString() {
  return 'VendorApplication(vendorId: $vendorId, userId: $userId, businessName: $businessName, contactEmail: $contactEmail, submittedAt: $submittedAt, registration: $registration, status: $status, moderationNote: $moderationNote, moderatedAt: $moderatedAt, appealMessage: $appealMessage, appealSubmittedAt: $appealSubmittedAt)';
}
...
@useResult
$Res call({
 String vendorId, String userId, String businessName, String contactEmail, DateTime submittedAt, VendorRegistration registration, VendorStatus status, String? moderationNote, DateTime? moderatedAt, String? appealMessage, DateTime? appealSubmittedAt
});
...
/// Create a copy of VendorApplication
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? vendorId = null,Object? userId = null,Object? businessName = null,Object? contactEmail = null,Object? submittedAt = null,Object? registration = null,Object? status = null,Object? moderationNote = freezed,Object? moderatedAt = freezed,Object? appealMessage = freezed,Object? appealSubmittedAt = freezed,}) {
...
as DateTime?,appealMessage: freezed == appealMessage ? _self.appealMessage : appealMessage // ignore: cast_nullable_to_non_nullable
as String?,appealSubmittedAt: freezed == appealSubmittedAt ? _self.appealSubmittedAt : appealSubmittedAt // ignore: cast_nullable_to_non_nullable
as DateTime?,
  ));
}
/// Create a copy of VendorApplication
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String vendorId,  String userId,  String businessName,  String contactEmail,  DateTime submittedAt,  VendorRegistration registration,  VendorStatus status,  String? moderationNote,  DateTime? moderatedAt,  String? appealMessage,  DateTime? appealSubmittedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _VendorApplication() when $default != null:
return $default(_that.vendorId,_that.userId,_that.businessName,_that.contactEmail,_that.submittedAt,_that.registration,_that.status,_that.moderationNote,_that.moderatedAt,_that.appealMessage,_that.appealSubmittedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String vendorId,  String userId,  String businessName,  String contactEmail,  DateTime submittedAt,  VendorRegistration registration,  VendorStatus status,  String? moderationNote,  DateTime? moderatedAt,  String? appealMessage,  DateTime? appealSubmittedAt)  $default,) {final _that = this;
switch (_that) {
case _VendorApplication():
return $default(_that.vendorId,_that.userId,_that.businessName,_that.contactEmail,_that.submittedAt,_that.registration,_that.status,_that.moderationNote,_that.moderatedAt,_that.appealMessage,_that.appealSubmittedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String vendorId,  String userId,  String businessName,  String contactEmail,  DateTime submittedAt,  VendorRegistration registration,  VendorStatus status,  String? moderationNote,  DateTime? moderatedAt,  String? appealMessage,  DateTime? appealSubmittedAt)?  $default,) {final _that = this;
switch (_that) {
case _VendorApplication() when $default != null:
return $default(_that.vendorId,_that.userId,_that.businessName,_that.contactEmail,_that.submittedAt,_that.registration,_that.status,_that.moderationNote,_that.moderatedAt,_that.appealMessage,_that.appealSubmittedAt);case _:
  return null;
...
class _VendorApplication implements VendorApplication {
  const _VendorApplication({required this.vendorId, required this.userId, required this.businessName, required this.contactEmail, required this.submittedAt, required this.registration, required this.status, this.moderationNote, this.moderatedAt, this.appealMessage, this.appealSubmittedAt});
...
@override final  String? appealMessage;
@override final  DateTime? appealSubmittedAt;
...
/// Create a copy of VendorApplication
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? vendorId = null,Object? userId = null,Object? businessName = null,Object? contactEmail = null,Object? submittedAt = null,Object? registration = null,Object? status = null,Object? moderationNote = freezed,Object? moderatedAt = freezed,Object? appealMessage = freezed,Object? appealSubmittedAt = freezed,}) {
