...
mixin _$AdminNotification {
 ...
 String get id; String get title; String get body; DateTime get createdAt; bool get read; AdminNotificationType get type; String? get linkedVendorId;
...
@useResult
$Res call({
 String id, String title, String body, DateTime createdAt, bool read, AdminNotificationType type, String? linkedVendorId
});
...
/// Create a copy of AdminNotification
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? title = null,Object? body = null,Object? createdAt = null,Object? read = null,Object? type = null,Object? linkedVendorId = freezed,}) {
...
as AdminNotificationType,linkedVendorId: freezed == linkedVendorId ? _self.linkedVendorId : linkedVendorId // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String title,  String body,  DateTime createdAt,  bool read,  AdminNotificationType type,  String? linkedVendorId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AdminNotification() when $default != null:
return $default(_that.id,_that.title,_that.body,_that.createdAt,_that.read,_that.type,_that.linkedVendorId);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String title,  String body,  DateTime createdAt,  bool read,  AdminNotificationType type,  String? linkedVendorId)  $default,) {final _that = this;
switch (_that) {
case _AdminNotification():
return $default(_that.id,_that.title,_that.body,_that.createdAt,_that.read,_that.type,_that.linkedVendorId);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String title,  String body,  DateTime createdAt,  bool read,  AdminNotificationType type,  String? linkedVendorId)?  $default,) {final _that = this;
switch (_that) {
case _AdminNotification() when $default != null:
return $default(_that.id,_that.title,_that.body,_that.createdAt,_that.read,_that.type,_that.linkedVendorId);case _:
  return null;
...
class _AdminNotification implements AdminNotification {
  const _AdminNotification({required this.id, required this.title, required this.body, required this.createdAt, this.read = false, this.type = AdminNotificationType.systemAlert, this.linkedVendorId});
...
@override@JsonKey() final  AdminNotificationType type;
@override final  String? linkedVendorId;
...
/// Create a copy of AdminNotification
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? title = null,Object? body = null,Object? createdAt = null,Object? read = null,Object? type = null,Object? linkedVendorId = freezed,}) {
