...
mixin _$DeliveryUpdate {
 ...
 String get id; String get orderId; DeliveryStage get stage; String get note; DateTime get updatedAt; String? get photoProofPath;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,orderId,stage,note,updatedAt,photoProofPath);
...
@useResult
$Res call({
 String id, String orderId, DeliveryStage stage, String note, DateTime updatedAt, String? photoProofPath
});
...
/// Create a copy of DeliveryUpdate
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? orderId = null,Object? stage = null,Object? note = null,Object? updatedAt = null,Object? photoProofPath = freezed,}) {
...
as DateTime,photoProofPath: freezed == photoProofPath ? _self.photoProofPath : photoProofPath // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String orderId,  DeliveryStage stage,  String note,  DateTime updatedAt,  String? photoProofPath)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DeliveryUpdate() when $default != null:
return $default(_that.id,_that.orderId,_that.stage,_that.note,_that.updatedAt,_that.photoProofPath);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String orderId,  DeliveryStage stage,  String note,  DateTime updatedAt,  String? photoProofPath)  $default,) {final _that = this;
switch (_that) {
case _DeliveryUpdate():
return $default(_that.id,_that.orderId,_that.stage,_that.note,_that.updatedAt,_that.photoProofPath);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String orderId,  DeliveryStage stage,  String note,  DateTime updatedAt,  String? photoProofPath)?  $default,) {final _that = this;
switch (_that) {
case _DeliveryUpdate() when $default != null:
return $default(_that.id,_that.orderId,_that.stage,_that.note,_that.updatedAt,_that.photoProofPath);case _:
  return null;
...
class _DeliveryUpdate implements DeliveryUpdate {
  const _DeliveryUpdate({required this.id, required this.orderId, required this.stage, required this.note, required this.updatedAt, this.photoProofPath});
...
@override final  String? photoProofPath;
...
/// Create a copy of DeliveryUpdate
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? orderId = null,Object? stage = null,Object? note = null,Object? updatedAt = null,Object? photoProofPath = freezed,}) {
