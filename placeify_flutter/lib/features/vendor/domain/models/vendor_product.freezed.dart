...
class _VendorProduct extends VendorProduct {
  const _VendorProduct({required this.id, required this.vendorId, required this.name, required this.sku, required this.price, required this.stock, final  List<String> imageUrls = const [], required this.categoryId, this.isActive = true, required this.createdAt, this.description = '', this.brand = '', this.originalPrice, this.offerLabel = '', this.widthCm = 0, this.depthCm = 0, this.heightCm = 0, this.weightKg = 0, this.hasArView = false, this.materials = ''}): _imageUrls = imageUrls,super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,vendorId,name,sku,price,stock,const DeepCollectionEquality().hash(_imageUrls),categoryId,isActive,createdAt,description,brand,originalPrice,offerLabel,widthCm,depthCm,heightCm,weightKg,hasArView,materials]);
