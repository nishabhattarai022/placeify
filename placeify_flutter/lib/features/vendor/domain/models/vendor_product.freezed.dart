...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,vendorId,name,sku,price,stock,const DeepCollectionEquality().hash(imageUrls),categoryId,isActive,createdAt,description,brand,originalPrice,offerLabel,widthCm,depthCm,heightCm,weightKg,hasArView,materials,lowStockThreshold]);
...
/// Create a copy of VendorProduct
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? vendorId = null,Object? name = null,Object? sku = null,Object? price = null,Object? stock = null,Object? imageUrls = null,Object? categoryId = null,Object? isActive = null,Object? createdAt = null,Object? description = null,Object? brand = null,Object? originalPrice = freezed,Object? offerLabel = null,Object? widthCm = null,Object? depthCm = null,Object? heightCm = null,Object? weightKg = null,Object? hasArView = null,Object? materials = null,Object? lowStockThreshold = null,}) {
...
class _VendorProduct extends VendorProduct {
  const _VendorProduct({required this.id, required this.vendorId, required this.name, required this.sku, required this.price, required this.stock, final  List<String> imageUrls = const [], required this.categoryId, this.isActive = true, required this.createdAt, this.description = '', this.brand = '', this.originalPrice, this.offerLabel = '', this.widthCm = 0, this.depthCm = 0, this.heightCm = 0, this.weightKg = 0, this.hasArView = false, this.materials = '', this.lowStockThreshold = 5}): _imageUrls = imageUrls,super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,vendorId,name,sku,price,stock,const DeepCollectionEquality().hash(_imageUrls),categoryId,isActive,createdAt,description,brand,originalPrice,offerLabel,widthCm,depthCm,heightCm,weightKg,hasArView,materials,lowStockThreshold]);
