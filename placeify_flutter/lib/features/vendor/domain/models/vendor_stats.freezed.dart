...
mixin _$VendorStats {
  ...
  $VendorStatsCopyWith<VendorStats> get copyWith =>
      _$VendorStatsCopyWithImpl<VendorStats>(this as VendorStats, _$identity);
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, revenue, orderCount,
      productCount, viewCount, conversionRate, periodLabel);
...
abstract mixin class $VendorStatsCopyWith<$Res> {
  factory $VendorStatsCopyWith(
          VendorStats value, $Res Function(VendorStats) _then) =
      _$VendorStatsCopyWithImpl;
  @useResult
  $Res call(
      {double revenue,
      int orderCount,
...
/// @nodoc
class _$VendorStatsCopyWithImpl<$Res> implements $VendorStatsCopyWith<$Res> {
...
extension VendorStatsPatterns on VendorStats {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(double revenue, int orderCount, int productCount,
            int viewCount, double conversionRate, String periodLabel)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _VendorStats() when $default != null:
        return $default(_that.revenue, _that.orderCount, _that.productCount,
            _that.viewCount, _that.conversionRate, _that.periodLabel);
      case _:
        return orElse();
    }
  }
...
class _VendorStats implements VendorStats {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$VendorStatsCopyWith<_VendorStats> get copyWith =>
      __$VendorStatsCopyWithImpl<_VendorStats>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$VendorStatsToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$VendorStatsCopyWith<$Res>
    implements $VendorStatsCopyWith<$Res> {
  factory _$VendorStatsCopyWith(
          _VendorStats value, $Res Function(_VendorStats) _then) =
      __$VendorStatsCopyWithImpl;
  @override
  @useResult
  $Res call(
      {double revenue,
...
/// @nodoc
class __$VendorStatsCopyWithImpl<$Res> implements _$VendorStatsCopyWith<$Res> {
