...
import '../models/picked_product_image.dart';

/// Serverpod commerce API for shop setup, product upload, and 3D generation.
abstract class VendorCommerceRepository {
...
class VendorCommerceRepositoryException implements Exception {
  VendorCommerceRepositoryException(this.message, {this.code});
