...
final class AdminNotificationsProvider extends $AsyncNotifierProvider<
...
abstract class _$AdminNotifications
  ...
  void runBuild() {
    final ref = this.ref
        as $Ref<AsyncValue<List<AdminNotification>>, List<AdminNotification>>;
    final element = ref.element as $ClassProviderElement<
        AnyNotifier<AsyncValue<List<AdminNotification>>,
