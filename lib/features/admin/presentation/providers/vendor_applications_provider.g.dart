...
final class VendorApplicationsListProvider extends $AsyncNotifierProvider<
    VendorApplicationsList, List<VendorApplication>> {
...
final class VendorApplicationsListFamily extends $Family
  ...
  VendorApplicationsListProvider call(
...
abstract class _$VendorApplicationsList
  ...
  FutureOr<List<VendorApplication>> build(
    VendorApplicationListFilter filter,
  );
  @$mustCallSuper
  @override
  void runBuild() {
    final ref = this.ref
        as $Ref<AsyncValue<List<VendorApplication>>, List<VendorApplication>>;
    final element = ref.element as $ClassProviderElement<
        AnyNotifier<AsyncValue<List<VendorApplication>>,
            List<VendorApplication>>,
        AsyncValue<List<VendorApplication>>,
        Object?,
        Object?>;
...
final class VendorApplicationDetailProvider extends $FunctionalProvider<
...
final class VendorApplicationDetailFamily extends $Family
  ...
  VendorApplicationDetailProvider call(
    String vendorId,
  ) =>
