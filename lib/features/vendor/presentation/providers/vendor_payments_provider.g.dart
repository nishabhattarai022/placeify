...
final class VendorPaymentRepositoryProvider extends $FunctionalProvider<
    VendorPaymentRepository,
    VendorPaymentRepository,
    VendorPaymentRepository> with $Provider<VendorPaymentRepository> {
...
final class OrderPaymentAuditTrailProvider extends $FunctionalProvider<
...
final class OrderPaymentAuditTrailFamily extends $Family
  ...
  OrderPaymentAuditTrailProvider call(
    String orderId,
  ) =>
