...
mixin _$VendorProfile {
 ...
 String get id; String get businessName; String get email; String get phone; String get address; String get category; String? get logoUrl; DateTime get createdAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,businessName,email,phone,address,category,logoUrl,createdAt);
...
@useResult
$Res call({
 String id, String businessName, String email, String phone, String address, String category, String? logoUrl, DateTime createdAt
});
...
/// Create a copy of VendorProfile
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? businessName = null,Object? email = null,Object? phone = null,Object? address = null,Object? category = null,Object? logoUrl = freezed,Object? createdAt = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String businessName,  String email,  String phone,  String address,  String category,  String? logoUrl,  DateTime createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _VendorProfile() when $default != null:
return $default(_that.id,_that.businessName,_that.email,_that.phone,_that.address,_that.category,_that.logoUrl,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String businessName,  String email,  String phone,  String address,  String category,  String? logoUrl,  DateTime createdAt)  $default,) {final _that = this;
switch (_that) {
case _VendorProfile():
return $default(_that.id,_that.businessName,_that.email,_that.phone,_that.address,_that.category,_that.logoUrl,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String businessName,  String email,  String phone,  String address,  String category,  String? logoUrl,  DateTime createdAt)?  $default,) {final _that = this;
switch (_that) {
case _VendorProfile() when $default != null:
return $default(_that.id,_that.businessName,_that.email,_that.phone,_that.address,_that.category,_that.logoUrl,_that.createdAt);case _:
  return null;
...
class _VendorProfile implements VendorProfile {
  const _VendorProfile({required this.id, required this.businessName, required this.email, required this.phone, required this.address, required this.category, this.logoUrl, required this.createdAt});
...
/// Create a copy of VendorProfile
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? businessName = null,Object? email = null,Object? phone = null,Object? address = null,Object? category = null,Object? logoUrl = freezed,Object? createdAt = null,}) {
