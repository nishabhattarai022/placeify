...
mixin _$VendorProduct {
 ...
 String get id; String get vendorId; String get name; String get sku; double get price; int get stock; List<String> get imageUrls; String get categoryId; bool get isActive; DateTime get createdAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,vendorId,name,sku,price,stock,const DeepCollectionEquality().hash(imageUrls),categoryId,isActive,createdAt);
...
@useResult
$Res call({
 String id, String vendorId, String name, String sku, double price, int stock, List<String> imageUrls, String categoryId, bool isActive, DateTime createdAt
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String vendorId,  String name,  String sku,  double price,  int stock,  List<String> imageUrls,  String categoryId,  bool isActive,  DateTime createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _VendorProduct() when $default != null:
return $default(_that.id,_that.vendorId,_that.name,_that.sku,_that.price,_that.stock,_that.imageUrls,_that.categoryId,_that.isActive,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String vendorId,  String name,  String sku,  double price,  int stock,  List<String> imageUrls,  String categoryId,  bool isActive,  DateTime createdAt)  $default,) {final _that = this;
switch (_that) {
case _VendorProduct():
return $default(_that.id,_that.vendorId,_that.name,_that.sku,_that.price,_that.stock,_that.imageUrls,_that.categoryId,_that.isActive,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String vendorId,  String name,  String sku,  double price,  int stock,  List<String> imageUrls,  String categoryId,  bool isActive,  DateTime createdAt)?  $default,) {final _that = this;
switch (_that) {
case _VendorProduct() when $default != null:
return $default(_that.id,_that.vendorId,_that.name,_that.sku,_that.price,_that.stock,_that.imageUrls,_that.categoryId,_that.isActive,_that.createdAt);case _:
  return null;
...
class _VendorProduct implements VendorProduct {
  const _VendorProduct({required this.id, required this.vendorId, required this.name, required this.sku, required this.price, required this.stock, final  List<String> imageUrls = const [], required this.categoryId, this.isActive = true, required this.createdAt}): _imageUrls = imageUrls;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,vendorId,name,sku,price,stock,const DeepCollectionEquality().hash(_imageUrls),categoryId,isActive,createdAt);
