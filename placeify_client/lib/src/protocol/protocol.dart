...
import 'package:placeify_client/src/protocol/order_delivery_update.dart'
    as _i54;
import 'package:placeify_client/src/protocol/category.dart' as _i55;
import 'package:placeify_client/src/protocol/product.dart' as _i56;
import 'package:placeify_client/src/protocol/refund_request_summary.dart'
    as _i57;
import 'package:placeify_client/src/protocol/review.dart' as _i58;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == List<_i54.OrderDeliveryUpdate>) {
      return (data as List)
              .map((e) => deserialize<_i54.OrderDeliveryUpdate>(e))
              .toList()
          as T;
    }
    ...
    if (t == List<_i57.RefundRequestSummary>) {
      return (data as List)
              .map((e) => deserialize<_i57.RefundRequestSummary>(e))
              .toList()
          as T;
    }
