...
| `user.completePayment` | Yes | Mark order payment succeeded (mock/COD dev flow) | `UserOrderPaymentSummary` |
...
| `test/integration/user_payment_flow_test.dart` | Checkout payment pending → completePayment → vendor order |
