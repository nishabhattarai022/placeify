...
--
-- Class SpecialOffer as table special_offer
--
...
--
-- Foreign relations for "special_offer" table
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('placeify', '20260713030346937', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260713030346937', "timestamp" = now();
