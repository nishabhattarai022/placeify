...
--
-- Class AdminAuditLog as table admin_audit_log
--
...
--
-- Class EmailVerificationPending as table email_verification_pending
--
...
CREATE TABLE "vendor" (
    ...
    "appealMessage" text,
    "appealSubmittedAt" timestamp without time zone,
    "createdAt" timestamp without time zone NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" timestamp without time zone NOT NULL DEFAULT CURRENT_TIMESTAMP
);
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('placeify', '20260723170005535-review-updated-at', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260723170005535-review-updated-at', "timestamp" = now();
