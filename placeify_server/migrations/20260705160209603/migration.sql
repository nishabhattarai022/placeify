...
ALTER TABLE "complaint" ADD COLUMN "assignedToId" uuid;
ALTER TABLE "complaint" ADD COLUMN "internalNote" text;
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('placeify', '20260705160209603', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260705160209603', "timestamp" = now();
