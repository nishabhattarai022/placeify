...
WIRING_FILES=(
  ...
  placeify_flutter/lib/features/user/presentation/user_cart_page.dart
  ...
  placeify_flutter/lib/features/profile/presentation/providers/profile_refunds_provider.g.dart
