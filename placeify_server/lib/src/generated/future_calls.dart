...
import '../modules/vendor/product_3d/product_3d_generation_future_call.dart'
    as _i4;
...
class FutureCalls extends _i1.FutureCallDispatch<_FutureCallRef> {
  ...
  void initialize(
    ...
    var registeredFutureCalls = <String, _i1.FutureCall>{
      'Product3dGenerationInvokeFutureCall':
          Product3dGenerationInvokeFutureCall(),
    };
...
class _FutureCallRef {
  ...
  late final product3dGeneration = _Product3dGenerationFutureCallDispatcher(
    _invokeFutureCall,
  );
}

class _Product3dGenerationFutureCallDispatcher {
  _Product3dGenerationFutureCallDispatcher(this._invokeFutureCall);

  final _InvokeFutureCall _invokeFutureCall;

  Future<void> invoke(_i2.Product3dGenerationTrigger? trigger) {
...
class Product3dGenerationInvokeFutureCall
    extends _i1.FutureCall<_i2.Product3dGenerationTrigger> {
  @override
  _i3.Future<void> invoke(
    _i1.Session session,
    _i2.Product3dGenerationTrigger? trigger,
  ) async {
    await _i4.Product3dGenerationFutureCall().invoke(
      session,
      trigger,
    );
  }
